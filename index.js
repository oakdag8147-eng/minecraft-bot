...
// ATERNOS "BAĞLAN" PENCERESİNDEN ALDIĞIN ANLIK BİLGİLER
const ATERNOS_HOST = 'lampfish.aternos.host'; // Buraya Aternos'taki Dinamik IP'yi yaz (.aternos.host olan kısım)
const ATERNOS_PORT = 52241;                // Buraya Aternos'taki 5 haneli Port'u yaz

let isReconnecting = false;

function startBot() {
  console.log(`Hedefe Doğrudan Baglaniliyor: ${ATERNOS_HOST}:${ATERNOS_PORT}...`);
  ...
  function safeReconnect() {
    ...
    isReconnecting = true;
    console.log('Baglanti koptu. 20sn sonra tekrar deneniyor...');
    try { bot.end(); } catch (e) {}
